Vue.component('container-tableau', {
    ...
    <main>
      <h5 class="mt-4 ml-5">
        <a class="menu-actif" href="./connaissances.html">{{ titre }}</a>
      </h5>
          ...
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <a href="#addEmployeeModal" class="btn btn-light" data-toggle="modal">
                    <span>+ </span>
                    <span>&nbsp; Ajouter une {{ libelle }}</span>
                  </a>
                </div>
              </div>
            </div>
              ...
              <form>
                ...
                <div v-if="libelle === 'connaissance'" class="modal-body">					
                  <div class="form-group">
                    ...
                    <select required id="categorie" class="form-select" aria-label="select"></select>
                  </div>
                  <div class="form-group">
                    <label>Libellé</label>
                ...
                <div class="modal-body" v-else-if="libelle === 'projet'">					
                  <div class="form-group">
                    <label>Nom</label>
                ...
                <div v-else-if="libelle === 'projet'" class="modal-footer">
                  <input type="button" class="btn btn-default" data-dismiss="modal" value="Annuler">
                  <input onclick="createProjet()" type="submit" class="btn btn-color" value="Ajouter">
                </div>
              </form>
            </div>
          </div>
